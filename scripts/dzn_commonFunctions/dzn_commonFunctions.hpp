...
class CfgFunctions
{
	class dzn
	{
		...
		{
			file = "scripts\dzn_commonFunctions\functions\commonFunctions";
		...
		class areaFunctions
		{
			file = "scripts\dzn_commonFunctions\functions\areaFunctions";
		...
		class mapFunctions
		{
			file = "scripts\dzn_commonFunctions\functions\mapFunctions";
		...
		class envFunctions
		{
			file = "scripts\dzn_commonFunctions\functions\envFunctions";
		...
		class invFunctions
		{
			file = "scripts\dzn_commonFunctions\functions\invFunctions";
		...
		{
			file = "scripts\dzn_commonFunctions\functions\supportFunctions";
		...
		class uiFunctions
		{
			file = "scripts\dzn_commonFunctions\functions\uiFunctions";
